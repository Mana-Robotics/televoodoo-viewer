...
<div class="space-y-4 text-sm">
  ...
  <div>
    ...
    <pre class="bg-gray-900 border border-gray-800 p-2 overflow-auto">{JSON.stringify(inputPose, null, 2)}</pre>
  </div>
  <div>
    <h3 class="font-semibold mb-1">OUTPUT JSON</h3>
    <pre class="bg-gray-900 border border-gray-800 p-2 overflow-auto">{JSON.stringify(outputJson, null, 2)}</pre>
  </div>
</div>
